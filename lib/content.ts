...
export const latestPosts = [
  { category: "Обновление", date: "12.09.2026", title: "Replica: главное для новичков и вернувшихся игроков", summary: "Межсерверная Реплика, новые зоны, Каратель Тира, агатионы и изменения фарма – без сотен строк патчноута." },
  { category: "Патчноут", date: "11.09.2026", title: "Изменения классов в Forged in Battle", summary: "Какие умения переработаны и как это влияет на текущую мету." },
  { category: "База знаний", date: "09.09.2026", title: "Диверсант: навыки и приоритет изучения", summary: "Структурированный список редких, исключительных и улучшенных умений." },
  { category: "Сравнение", date: "07.09.2026", title: "Самурай против Диверсанта: фарм", summary: "Сопоставление опыта и адены на серверных и межсерверных локациях." },
  { category: "Гайд", date: "04.09.2026", title: "Как читать корейские патчноуты", summary: "Термины, расхождения локализаций и проверка игровых значений." },
];
