...
export const knowledgeSections = [
  { title: "Классы", description: "Архетипы, пути развития и роль в PvE и PvP.", icon: "classes", href: "classes" },
  { title: "Умения", description: "Эффекты, уровни изучения, стоимость и изменения по патчам.", icon: "skills", href: "skills" },
