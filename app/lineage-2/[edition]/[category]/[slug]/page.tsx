  ...
  return <main className="article-page">
    ...
    <section className="article-hero">
      ...
      <div className="relative z-10 mx-auto flex min-h-[600px] max-w-[1460px] items-end px-4 pb-12 pt-28 sm:px-6 lg:px-8 lg:pb-14"><div className="max-w-5xl">
        ...
        <div className="article-title-wrap"><h1><span>{article.title}</span></h1></div><p className="article-deck">{article.description}</p>
      </div></div>
    </section>
      ...
      <article className="article-body">
        ...
        <section className="article-next">
          ...
          <div className="article-next-primary">
            <Link className="next-section" href={categoryPath}><span className="article-next-card-icon"><Bell size={21}/></span><span className="article-next-card-arrow"><ArrowUpRight size={16}/></span><span className="article-next-card-copy"><small>{edition}</small><strong>Все материалы: {category}</strong></span></Link>
